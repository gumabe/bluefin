...
copr="alternateved/bleeding-emacs"
for i in ${copr}; do
   MAINTAINER="${i%%/*}"
   REPOSITORY="${i##*/}"
...
dnf5 copr enable alternateved/bleeding-emacs
...
rpm-ostree install libvirt-daemon-kvm libvirt-daemon-driver-storage-zfs libvirt-daemon-driver-storage libvirt awesome mate-settings-daemon mate-control-center mate-polkit stow firefox jetbrains-mono-fonts python3-pip flameshot fedora-release-sway-atomic sway-config-fedora terminator neovim netcat emacs-gtk+x11 emacs kitty kitty-shell-integration kitty-terminfo alacritty inotify-tools inotify-tools-devel blueman wl-clipboard wlr-randr cmake cpio meson at qt5ct qt6ct qt6-qtsvg swappy yad pipewire-utils pipewire-alsa pavucontrol pcmanfm xcompmgr copyq driverctl incus-client gamescope lightdm lightdm-settings gnome-session-xsession libffi-devel libtool libX11-devel libxml2-devel sddm-conf wxGTK-devel
